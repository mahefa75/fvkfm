          ...
          <div className="max-w-4xl mx-auto">
            <div className="space-y-8">
              <div className="relative pl-8 md:pl-0">
                <div className="md:flex items-start">
                  <div className="md:w-1/3 mb-4 md:mb-0 md:text-right md:pr-8">
                    <span className="text-xl font-bold text-amber-600">1975</span>
                  </div>
                  <div className="md:w-2/3 relative">
                    <div className="hidden md:block absolute top-2 -left-4 h-4 w-4 rounded-full bg-amber-500"></div>
              ...
              <div className="relative pl-8 md:pl-0">
                <div className="md:flex items-start">
                  <div className="md:w-1/3 mb-4 md:mb-0 md:text-right md:pr-8">
                    <span className="text-xl font-bold text-amber-600">1988</span>
                  </div>
                  <div className="md:w-2/3 relative">
                    <div className="hidden md:block absolute top-2 -left-4 h-4 w-4 rounded-full bg-amber-500"></div>
              ...
              <div className="relative pl-8 md:pl-0">
                <div className="md:flex items-start">
                  <div className="md:w-1/3 mb-4 md:mb-0 md:text-right md:pr-8">
                    <span className="text-xl font-bold text-amber-600">2002</span>
                  </div>
                  <div className="md:w-2/3 relative">
                    <div className="hidden md:block absolute top-2 -left-4 h-4 w-4 rounded-full bg-amber-500"></div>
              ...
              <div className="relative pl-8 md:pl-0">
                <div className="md:flex items-start">
                  <div className="md:w-1/3 mb-4 md:mb-0 md:text-right md:pr-8">
                    <span className="text-xl font-bold text-amber-600">2015</span>
                  </div>
                  <div className="md:w-2/3 relative">
                    <div className="hidden md:block absolute top-2 -left-4 h-4 w-4 rounded-full bg-amber-500"></div>
              ...
              <div className="relative pl-8 md:pl-0">
                <div className="md:flex items-start">
                  <div className="md:w-1/3 mb-4 md:mb-0 md:text-right md:pr-8">
                    <span className="text-xl font-bold text-amber-600">Today</span>
                  </div>
                  <div className="md:w-2/3 relative">
                    <div className="hidden md:block absolute top-2 -left-4 h-4 w-4 rounded-full bg-amber-500"></div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-amber-600">Pasteur principal</p>
            ...
            <div className="text-center">
              ...
              <p className="text-amber-600">Pasteur associé</p>
              <p className="mt-2 text-gray-600">
            ...
            <div className="text-center">
              ...
              <p className="text-amber-600">Pasteur de louange</p>
              <p className="mt-2 text-gray-600">
