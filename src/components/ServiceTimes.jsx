      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white p-6 rounded-lg shadow-md transform transition-transform hover:scale-105">
            <h3 className="text-xl font-semibold text-primary mb-2">Culte du dimanche matin</h3>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md transform transition-transform hover:scale-105">
            <h3 className="text-xl font-semibold text-primary mb-2">Culte du dimanche soir</h3>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md transform transition-transform hover:scale-105">
            <h3 className="text-xl font-semibold text-primary mb-2">Étude biblique du mercredi</h3>
        ...
        <div className="mt-12 text-center">
          <div className="inline-block bg-white px-6 py-4 rounded-lg shadow-md">
            <h3 className="text-xl font-semibold text-primary mb-2">Services spéciaux</h3>
