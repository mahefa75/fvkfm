      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="mb-8">
              <h3 className="text-xl font-semibold text-amber-600 mb-3">Mission</h3>
            ...
            <div className="mb-8">
              <h3 className="text-xl font-semibold text-amber-600 mb-3">Vision</h3>
              <p className="text-gray-700">
            ...
            <div>
              <h3 className="text-xl font-semibold text-amber-600 mb-3">Valeurs</h3>
